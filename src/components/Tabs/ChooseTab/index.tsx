        ...
        <>
            <div className={styles.chooseName}>
                <div className={styles.name}>
                    ...
                    <input className={styles.input} type="text" maxLength={100} onChange={e => setName(e.target.value)} />
                </div>
                <div className={styles.level}>
                    <label className={styles.label}>Level:</label>
                    <select className={styles.select} defaultValue={LEVELS.EASY} onChange={e => setLevel(e.target.value)}>
